...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+263781328870', // Mettez votre numéro ici
    BOT_NAME: "ICON-X Mini",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɪᴄᴏɴ-x ᴍᴅ',
    ...
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8669803330:AAF0t-k67uIg7djPibnaAlTDpWIX-hcP-T4',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8685813457'
